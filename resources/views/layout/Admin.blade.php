...
<body>
   ...
   <aside>
    ...
    <a href="/course">
        <span class="side-icon"><i class="fa-solid fa-book"></i></span>
        <span class="side-text">Courses</span>
    </a>

    <a href="/department">
        <span class="side-icon"><i class="fa-solid fa-building-columns"></i></span>
    ...
    <a href="/professor">
        <span class="side-icon"><i class="fa-solid fa-chalkboard-user"></i></span>
        <span class="side-text">Professors</span>
    </a>

    <a href="/student">
        <span class="side-icon"><i class="fa-solid fa-user-graduate"></i></span>
